...
import { EMPTY_DIRECTIVE, type TurnDirective, type UtteranceKind } from "./discussion-turns";
 ...
 * discussion skill, where the criteria are still open, and getting it wrong
 * there is expensive: a decision may never be inferred from silence, a
 * question or plain agreement, and one recorded by mistake has to be struck
 * through rather than removed. Keyword matching is enough to drive a screen
 * and to keep the server honest about the shape of the contract; it is not
 * the contract, and it is meant to be deleted.
 *
